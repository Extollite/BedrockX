...
public:
	...
	MCINLINE class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const& getScoreTag() const {
	...
	MCINLINE void buildDebugInfo(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>& a0) const {
	...
	MCINLINE static void checkEntityOnewayCollision(class BlockSource& a0, class BlockPos const& a1) {
		return ((void (*)(class BlockSource&, class BlockPos const&))dlsym("?checkEntityOnewayCollision@Actor@@SAXAEAVBlockSource@@AEBVBlockPos@@@Z"))(a0, a1);
	}
	...
	MCINLINE bool hasTag(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const& a0) const {
		bool (Actor::*rv)(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const&) const;
	...
	MCINLINE class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> getExitTip(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const& a0, enum InputMode a1) const {
		class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> (Actor::*rv)(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const&, enum InputMode) const;
...
public:
	...
	MCINLINE void buildDebugInfo(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>& a0) const {
		void (Mob::*rv)(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>&) const;
