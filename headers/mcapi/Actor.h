...
public:
	...
	MCINLINE class Vec3 getAttachPos(enum ActorLocation a0, float a1) {
		class Vec3 (Actor::*rv)(enum ActorLocation, float);
	...
	MCINLINE class HashedString const& queryEntityRenderer() {
		class HashedString const& (Actor::*rv)();
	...
	MCINLINE float getCameraOffset() {
		float (Actor::*rv)();
		*((void**)&rv) = dlsym("?getCameraOffset@Actor@@UEBAMXZ");
		return (this->*rv)();
	}
	MCINLINE bool isDamageBlocked(class ActorDamageSource const& a0) {
		bool (Actor::*rv)(class ActorDamageSource const&);
	...
	MCINLINE class AttributeInstance const& getAttribute(class Attribute const& a0) {
		class AttributeInstance const& (Actor::*rv)(class Attribute const&);
		*((void**)&rv) = dlsym("?getAttribute@Actor@@UEBAAEBVAttributeInstance@@AEBVAttribute@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE bool isFireImmune() {
		bool (Actor::*rv)();
	...
	MCINLINE class Player* getPlayerOwner() {
		class Player* (Actor::*rv)();
		*((void**)&rv) = dlsym("?getPlayerOwner@Actor@@QEBAPEAVPlayer@@XZ");
		return (this->*rv)();
	}
	MCINLINE bool canDestroyBlock(class Block const& a0) {
		bool (Actor::*rv)(class Block const&);
		*((void**)&rv) = dlsym("?canDestroyBlock@Actor@@UEBA_NAEBVBlock@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE bool canSee(class Actor const& a0) {
	...
	MCINLINE enum ArmorTextureType getArmorMaterialTextureTypeInSlot(enum ArmorSlot a0) {
		enum ArmorTextureType (Actor::*rv)(enum ArmorSlot);
	...
	MCINLINE bool isUnderLiquid(enum MaterialType a0) {
		bool (Actor::*rv)(enum MaterialType);
		*((void**)&rv) = dlsym("?isUnderLiquid@Actor@@UEBA_NW4MaterialType@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE void _sendLinkPacket(struct ActorLink const& a0) {
		void (Actor::*rv)(struct ActorLink const&);
	...
	MCINLINE class ItemStack const& getArmor(enum ArmorSlot a0) {
		class ItemStack const& (Actor::*rv)(enum ArmorSlot);
	...
	MCINLINE int getStrength() {
		int (Actor::*rv)();
		*((void**)&rv) = dlsym("?getStrength@Actor@@QEBAHXZ");
		return (this->*rv)();
	}
	MCINLINE float getInterpolatedWalkAnimSpeed(float a0) {
	...
	MCINLINE bool isSneaking() {
		bool (Actor::*rv)();
		*((void**)&rv) = dlsym("?isSneaking@Actor@@UEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE bool isInWall() {
		bool (Actor::*rv)();
	...
	MCINLINE float getRiderYRotation(class Actor const& a0) {
		float (Actor::*rv)(class Actor const&);
	...
	MCINLINE int getEquipSlots() {
		int (Actor::*rv)();
		*((void**)&rv) = dlsym("?getEquipSlots@Actor@@UEBAHXZ");
		return (this->*rv)();
	}
	MCINLINE int getPortalWaitTime() {
		int (Actor::*rv)();
	...
	MCINLINE bool isSurfaceMob() {
		bool (Actor::*rv)();
		*((void**)&rv) = dlsym("?isSurfaceMob@Actor@@UEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE float getInterpolatedHeadRot(float a0) {
		float (Actor::*rv)(float);
		*((void**)&rv) = dlsym("?getInterpolatedHeadRot@Actor@@UEBAMM@Z");
		return (this->*rv)(a0);
	}
	MCINLINE class ItemStack const& getCarriedItem() {
		class ItemStack const& (Actor::*rv)();
	...
	MCINLINE bool canSeeInvisible() {
		bool (Actor::*rv)();
		*((void**)&rv) = dlsym("?canSeeInvisible@Actor@@UEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE bool isInLava() {
		bool (Actor::*rv)();
		*((void**)&rv) = dlsym("?isInLava@Actor@@UEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE bool hasComponent(class Util::HashString const& a0) {
		bool (Actor::*rv)(class Util::HashString const&);
		*((void**)&rv) = dlsym("?hasComponent@Actor@@UEBA_NAEBVHashString@Util@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE bool canPowerJump() {
		bool (Actor::*rv)();
	...
	MCINLINE bool isImmersedInWater() {
		bool (Actor::*rv)();
		*((void**)&rv) = dlsym("?isImmersedInWater@Actor@@UEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE bool isJumping() {
		bool (Actor::*rv)();
	...
	MCINLINE float getShadowRadius() {
		float (Actor::*rv)();
		*((void**)&rv) = dlsym("?getShadowRadius@Actor@@UEBAMXZ");
		return (this->*rv)();
	}
	MCINLINE int getEquipmentCount() {
		int (Actor::*rv)();
	...
	MCINLINE bool isInsideBorderBlock(float a0) {
		bool (Actor::*rv)(float);
	...
	MCINLINE int getStructuralIntegrity() {
		int (Actor::*rv)();
	...
	MCINLINE class Vec3 getInterpolatedRidingOffset(float a0) {
	...
	MCINLINE float getInterpolatedBodyRot(float a0) {
		float (Actor::*rv)(float);
	...
	MCINLINE void reloadHardcoded(enum Actor::InitializationMethod a0, class VariantParameterList const& a1) {
	...
	MCINLINE bool isAlive() {
		bool (Actor::*rv)();
		*((void**)&rv) = dlsym("?isAlive@Actor@@UEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE bool canSynchronizeNewEntity() {
		bool (Actor::*rv)();
	...
	MCINLINE void loadLinks(class CompoundTag const& a0, class std::vector<struct ActorLink, class std::allocator<struct ActorLink>>& a1, class DataLoadHelper& a2) {
		void (Actor::*rv)(class CompoundTag const&, class std::vector<struct ActorLink, class std::allocator<struct ActorLink>>&, class DataLoadHelper&);
	...
	MCINLINE bool isInvulnerableTo(class ActorDamageSource const& a0) {
		bool (Actor::*rv)(class ActorDamageSource const&);
		*((void**)&rv) = dlsym("?isInvulnerableTo@Actor@@UEBA_NAEBVActorDamageSource@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const& getScoreTag() {
		class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const& (Actor::*rv)();
		*((void**)&rv) = dlsym("?getScoreTag@Actor@@UEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ");
		return (this->*rv)();
	} MCINLINE bool isCreative() {
		bool (Actor::*rv)();
	...
	MCINLINE struct ActorUniqueID const& getUniqueID() {
		struct ActorUniqueID const& (Actor::*rv)();
	...
	MCINLINE void buildDebugInfo(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>& a0) {
		void (Actor::*rv)(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>&);
	...
	MCINLINE bool hasTickingArea() {
		bool (Actor::*rv)();
		*((void**)&rv) = dlsym("?hasTickingArea@Actor@@QEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE bool canShowNameTag() {
		bool (Actor::*rv)();
	...
	MCINLINE class Vec3 getInterpolatedRidingPosition(float a0) {
		class Vec3 (Actor::*rv)(float);
	...
	MCINLINE enum PaletteColor getColor() {
		enum PaletteColor (Actor::*rv)();
	...
	MCINLINE bool canExistInPeaceful() {
		bool (Actor::*rv)();
	...
	MCINLINE bool canChangeDimensions() {
		bool (Actor::*rv)();
	...
	MCINLINE bool canBeAffectedByArrow(class MobEffectInstance const& a0) {
		bool (Actor::*rv)(class MobEffectInstance const&);
		*((void**)&rv) = dlsym("?canBeAffectedByArrow@Actor@@UEBA_NAEBVMobEffectInstance@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE void checkEntityOnewayCollision(class BlockSource& a0, class BlockPos const& a1) {
		void (Actor::*rv)(class BlockSource&, class BlockPos const&);
		*((void**)&rv) = dlsym("?checkEntityOnewayCollision@Actor@@SAXAEAVBlockSource@@AEBVBlockPos@@@Z");
		return (this->*rv)(a0, a1);
	}
	...
	MCINLINE unsigned __int64 getNameTagAsHash() {
		unsigned __int64 (Actor::*rv)();
	...
	MCINLINE class Vec3 const getPosExtrapolated(float a0) {
		class Vec3 const (Actor::*rv)(float);
		*((void**)&rv) = dlsym("?getPosExtrapolated@Actor@@UEBA?BVVec3@@M@Z");
		return (this->*rv)(a0);
	}
	MCINLINE bool isTargetable() {
		bool (Actor::*rv)();
	...
	MCINLINE bool hasEnteredWater() {
		bool (Actor::*rv)();
		*((void**)&rv) = dlsym("?hasEnteredWater@Actor@@UEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE bool hasPlayerRider() {
		bool (Actor::*rv)();
		*((void**)&rv) = dlsym("?hasPlayerRider@Actor@@QEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE void playSynchronizedSound(enum LevelSoundEvent a0, class Vec3 const& a1, int a2, bool a3) {
	...
	MCINLINE bool isControlledByLocalInstance() {
		bool (Actor::*rv)();
		*((void**)&rv) = dlsym("?isControlledByLocalInstance@Actor@@QEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE bool hasFamily(class Util::HashString const& a0) {
		bool (Actor::*rv)(class Util::HashString const&);
	...
	MCINLINE bool canBePulledIntoVehicle() {
		bool (Actor::*rv)();
	...
	MCINLINE void reloadComponents(enum Actor::InitializationMethod a0, class VariantParameterList const& a1) {
		void (Actor::*rv)(enum Actor::InitializationMethod, class VariantParameterList const&);
		*((void**)&rv) = dlsym("?reloadComponents@Actor@@MEAAXW4InitializationMethod@1@AEBVVariantParameterList@@@Z");
		return (this->*rv)(a0, a1);
	}
	MCINLINE bool canAddRider(class Actor& a0) {
		bool (Actor::*rv)(class Actor&);
		*((void**)&rv) = dlsym("?canAddRider@Actor@@UEBA_NAEAV1@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE bool getAlwaysShowNameTag() {
		bool (Actor::*rv)();
	...
	MCINLINE enum ArmorMaterialType getArmorMaterialTypeInSlot(enum ArmorSlot a0) {
		enum ArmorMaterialType (Actor::*rv)(enum ArmorSlot);
	...
	MCINLINE void setBaseDefinition(struct ActorDefinitionIdentifier const& a0, bool a1, bool a2) {
		...
		*((void**)&rv) = dlsym("?setBaseDefinition@Actor@@QEAAXAEBUActorDefinitionIdentifier@@_N1@Z");
		return (this->*rv)(a0, a1, a2);
	}
	...
	MCINLINE void getDebugText(class std::vector<class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>, class std::allocator<class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>>>& a0) {
		void (Actor::*rv)(class std::vector<class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>, class std::allocator<class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>>>&);
	...
	MCINLINE float getYawSpeedInDegreesPerSecond() {
		float (Actor::*rv)();
	...
	MCINLINE class Vec3 getFiringPos() {
		class Vec3 (Actor::*rv)();
	...
	MCINLINE bool hasSubBBInLava() {
		bool (Actor::*rv)();
		*((void**)&rv) = dlsym("?hasSubBBInLava@Actor@@QEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE bool isInvertedHealAndHarm() {
		bool (Actor::*rv)();
		*((void**)&rv) = dlsym("?isInvertedHealAndHarm@Actor@@UEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE bool hasOutputSignal(unsigned char a0) {
		bool (Actor::*rv)(unsigned char);
	...
	MCINLINE float getArmorColorInSlot(enum ArmorSlot a0, int a1) {
		float (Actor::*rv)(enum ArmorSlot, int);
		*((void**)&rv) = dlsym("?getArmorColorInSlot@Actor@@UEBAMW4ArmorSlot@@H@Z");
		return (this->*rv)(a0, a1);
	}
	MCINLINE class Actor* getRideRoot() {
		class Actor* (Actor::*rv)();
	...
	MCINLINE bool isBlocking() {
		bool (Actor::*rv)();
		*((void**)&rv) = dlsym("?isBlocking@Actor@@UEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE bool hasTag(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const& a0) {
		bool (Actor::*rv)(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const&);
		*((void**)&rv) = dlsym("?hasTag@Actor@@QEBA_NAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z");
		return (this->*rv)(a0);
	}
	...
	MCINLINE bool intersects(class Vec3 const& a0, class Vec3 const& a1) {
		bool (Actor::*rv)(class Vec3 const&, class Vec3 const&);
		*((void**)&rv) = dlsym("?intersects@Actor@@UEBA_NAEBVVec3@@0@Z");
		return (this->*rv)(a0, a1);
	}
	MCINLINE int getPortalCooldown() {
		int (Actor::*rv)();
	...
	MCINLINE void forEachLeashedActor() {
		void (Actor::*rv)();
		*((void**)&rv) = dlsym("?forEachLeashedActor@Actor@@QEAAXV?$function@$$A6AXPEAVActor@@@Z@std@@@Z");
		return (this->*rv)();
	}
	MCINLINE void reloadHardcodedClient(enum Actor::InitializationMethod a0, class VariantParameterList const& a1) {
		void (Actor::*rv)(enum Actor::InitializationMethod, class VariantParameterList const&);
	...
	MCINLINE bool hasEffect(class MobEffect const& a0) {
		bool (Actor::*rv)(class MobEffect const&);
		*((void**)&rv) = dlsym("?hasEffect@Actor@@QEBA_NAEBVMobEffect@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE class AutomaticID<class Dimension, int> getDimensionId() {
		class AutomaticID<class Dimension, int> (Actor::*rv)();
	...
	MCINLINE void loadEntityFlags(class CompoundTag const& a0, class DataLoadHelper& a1) {
		void (Actor::*rv)(class CompoundTag const&, class DataLoadHelper&);
		*((void**)&rv) = dlsym("?loadEntityFlags@Actor@@QEAAXAEBVCompoundTag@@AEAVDataLoadHelper@@@Z");
		return (this->*rv)(a0, a1);
	}
	...
	MCINLINE bool isWithinRestriction(class BlockPos const& a0) {
		bool (Actor::*rv)(class BlockPos const&);
	...
	MCINLINE struct ActorUniqueID getControllingPlayer() {
		struct ActorUniqueID (Actor::*rv)();
	...
	MCINLINE float getMapDecorationRotation() {
		float (Actor::*rv)();
		*((void**)&rv) = dlsym("?getMapDecorationRotation@Actor@@UEBAMXZ");
		return (this->*rv)();
	}
	MCINLINE bool isOnFire() {
		bool (Actor::*rv)();
	...
	MCINLINE bool canBeAffected(int a0) {
		bool (Actor::*rv)(int);
	...
	MCINLINE struct ActorUniqueID getSourceUniqueID() {
		struct ActorUniqueID (Actor::*rv)();
	...
	MCINLINE void playSynchronizedSound(enum LevelSoundEvent a0, class Vec3 const& a1, class Block const& a2, bool a3) {
	...
	MCINLINE bool isImmobile() {
		bool (Actor::*rv)();
		*((void**)&rv) = dlsym("?isImmobile@Actor@@UEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE float getInterpolatedBodyYaw(float a0) {
		float (Actor::*rv)(float);
		*((void**)&rv) = dlsym("?getInterpolatedBodyYaw@Actor@@UEBAMM@Z");
		return (this->*rv)(a0);
	}
	MCINLINE bool isOverWater() {
		bool (Actor::*rv)();
	...
	MCINLINE class Vec3 getViewVector(float a0) {
		class Vec3 (Actor::*rv)(float);
		*((void**)&rv) = dlsym("?getViewVector@Actor@@QEBA?AVVec3@@M@Z");
		return (this->*rv)(a0);
	}
	MCINLINE enum CommandPermissionLevel getCommandPermissionLevel() {
		enum CommandPermissionLevel (Actor::*rv)();
		*((void**)&rv) = dlsym("?getCommandPermissionLevel@Actor@@UEBA?AW4CommandPermissionLevel@@XZ");
		return (this->*rv)();
	}
	MCINLINE bool shouldRender() {
		bool (Actor::*rv)();
		*((void**)&rv) = dlsym("?shouldRender@Actor@@UEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE bool onLadder(bool a0) {
		bool (Actor::*rv)(bool);
	...
	MCINLINE bool isUnderWaterfall() {
		bool (Actor::*rv)();
	...
	MCINLINE class Player* getTradingPlayer() {
		class Player* (Actor::*rv)();
	...
	MCINLINE enum PaletteColor getColor2() {
		enum PaletteColor (Actor::*rv)();
	...
	MCINLINE bool canMakeStepSound() {
		bool (Actor::*rv)();
		*((void**)&rv) = dlsym("?canMakeStepSound@Actor@@MEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE class ItemStack const& getEquippedTotem() {
		class ItemStack const& (Actor::*rv)();
	...
	MCINLINE class Vec3 const& getPosOld() {
		class Vec3 const& (Actor::*rv)();
	...
	MCINLINE bool canSee(class Vec3 const& a0) {
		bool (Actor::*rv)(class Vec3 const&);
		*((void**)&rv) = dlsym("?canSee@Actor@@UEBA_NAEBVVec3@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE void testForCollidableMobs(class BlockSource& a0, class AABB const& a1, class std::vector<class AABB, class std::allocator<class AABB>>& a2) {
		void (Actor::*rv)(class BlockSource&, class AABB const&, class std::vector<class AABB, class std::allocator<class AABB>>&);
		*((void**)&rv) = dlsym("?testForCollidableMobs@Actor@@QEAAXAEAVBlockSource@@AEBVAABB@@AEAV?$vector@VAABB@@V?$allocator@VAABB@@@std@@@std@@@Z");
		return (this->*rv)(a0, a1, a2);
	}
	MCINLINE bool isValidTarget(class Actor* a0) {
		bool (Actor::*rv)(class Actor*);
	...
	MCINLINE bool canAttack(class Actor* a0, bool a1) {
		bool (Actor::*rv)(class Actor*, bool);
	...
	MCINLINE class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const& getNameTag() {
		class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const& (Actor::*rv)();
	...
	MCINLINE bool canBeginOrContinueClimbingLadder(bool a0) {
		bool (Actor::*rv)(bool);
	...
	MCINLINE bool isRiding() {
		bool (Actor::*rv)();
		*((void**)&rv) = dlsym("?isRiding@Actor@@QEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE bool getInteraction(class Player& a0, class ActorInteraction& a1, class Vec3 const& a2) {
	...
	MCINLINE void adjustDamageAmount(int& a0) {
		void (Actor::*rv)(int&);
	...
	MCINLINE int getRiderIndex(class Actor& a0) {
		int (Actor::*rv)(class Actor&);
		*((void**)&rv) = dlsym("?getRiderIndex@Actor@@QEBAHAEAV1@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE enum ActorType getEntityTypeId() {
	...
	MCINLINE bool isRider(class Actor const& a0) {
		bool (Actor::*rv)(class Actor const&);
		*((void**)&rv) = dlsym("?isRider@Actor@@QEBA_NAEBV1@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE class Vec3 const& getPos() {
		class Vec3 const& (Actor::*rv)();
	...
	MCINLINE int getOutputSignal() {
		int (Actor::*rv)();
		*((void**)&rv) = dlsym("?getOutputSignal@Actor@@UEBAHXZ");
		return (this->*rv)();
	}
	MCINLINE void initializeComponents(enum Actor::InitializationMethod a0, class VariantParameterList const& a1) {
		void (Actor::*rv)(enum Actor::InitializationMethod, class VariantParameterList const&);
	...
	MCINLINE int getLifeSpan() {
		int (Actor::*rv)();
		*((void**)&rv) = dlsym("?getLifeSpan@Actor@@UEBAHXZ");
		return (this->*rv)();
	}
	MCINLINE int getDeathTime() {
		int (Actor::*rv)();
	...
	MCINLINE int getSkinID() {
		int (Actor::*rv)();
		*((void**)&rv) = dlsym("?getSkinID@Actor@@QEBAHXZ");
		return (this->*rv)();
	}
	MCINLINE class Actor* getTarget() {
		class Actor* (Actor::*rv)();
		*((void**)&rv) = dlsym("?getTarget@Actor@@QEBAPEAV1@XZ");
		return (this->*rv)();
	}
	MCINLINE void setScoreTag(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const& a0) {
	...
	MCINLINE bool canBeAffected(class MobEffectInstance const& a0) {
		bool (Actor::*rv)(class MobEffectInstance const&);
	...
	MCINLINE void sendActorDefinitionEventTriggered(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const& a0) {
		void (Actor::*rv)(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const&);
		*((void**)&rv) = dlsym("?sendActorDefinitionEventTriggered@Actor@@QEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z");
		return (this->*rv)(a0);
	}
	...
	MCINLINE bool getStatusFlag(enum ActorFlags a0) {
		bool (Actor::*rv)(enum ActorFlags);
		*((void**)&rv) = dlsym("?getStatusFlag@Actor@@QEBA_NW4ActorFlags@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE float getBrightness(float a0) {
		float (Actor::*rv)(float);
		*((void**)&rv) = dlsym("?getBrightness@Actor@@UEBAMM@Z");
		return (this->*rv)(a0);
	}
	MCINLINE struct ActorUniqueID const getOwnerId() {
		struct ActorUniqueID const (Actor::*rv)();
		*((void**)&rv) = dlsym("?getOwnerId@Actor@@QEBA?BUActorUniqueID@@XZ");
		return (this->*rv)();
	}
	MCINLINE int getVariant() {
		int (Actor::*rv)();
	...
	MCINLINE bool canCurrentlySwim() {
		bool (Actor::*rv)();
	...
	MCINLINE void _setNetherPortalData(class AutomaticID<class Dimension, int> a0, class AutomaticID<class Dimension, int> a1, int a2) {
		void (Actor::*rv)(class AutomaticID<class Dimension, int>, class AutomaticID<class Dimension, int>, int);
		*((void**)&rv) = dlsym("?_setNetherPortalData@Actor@@IEAAXV?$AutomaticID@VDimension@@H@@0H@Z");
		return (this->*rv)(a0, a1, a2);
	}
	...
	MCINLINE class MobEffectInstance const* getEffect(class MobEffect const& a0) {
		class MobEffectInstance const* (Actor::*rv)(class MobEffect const&);
...
void (Actor::*rv)(class std::unique_ptr<class CompoundTag,struct std::default_delete<class CompoundTag> >,int); *((void**)&rv) = dlsym("?savePersistingTrade@Actor@@QEAAXV?$unique_ptr@VCompoundTag@@U?$default_delete@VCompoundTag@@@std@@@std@@H@Z"); return (this->*rv)(a0,a1);}
	MCINLINE class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >  getFormattedNameTag(){
class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > (Actor::*rv)(); *((void**)&rv) = dlsym("?getFormattedNameTag@Actor@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"); return (this->*rv)();}
...
class std::unique_ptr<class CompoundTag,struct std::default_delete<class CompoundTag> > (Actor::*rv)(); *((void**)&rv) = dlsym("?getPersistingTradeOffers@Actor@@QEAA?AV?$unique_ptr@VCompoundTag@@U?$default_delete@VCompoundTag@@@std@@@std@@XZ"); return (this->*rv)();}
	MCINLINE class std::unique_ptr<class ListTag,struct std::default_delete<class ListTag> >  saveLinks(){
class std::unique_ptr<class ListTag,struct std::default_delete<class ListTag> > (Actor::*rv)(); *((void**)&rv) = dlsym("?saveLinks@Actor@@QEBA?AV?$unique_ptr@VListTag@@U?$default_delete@VListTag@@@std@@@std@@XZ"); return (this->*rv)();}
...
class std::vector<struct DistanceSortedActor,class std::allocator<struct DistanceSortedActor> > (Actor::*rv)(class Vec3 const &,enum ActorType); *((void**)&rv) = dlsym("?fetchNearbyActorsSorted@Actor@@QEAA?AV?$vector@UDistanceSortedActor@@V?$allocator@UDistanceSortedActor@@@std@@@std@@AEBVVec3@@W4ActorType@@@Z"); return (this->*rv)(a0,a1);}
	MCINLINE class std::vector<struct ActorLink,class std::allocator<struct ActorLink> >  getLinks(){
class std::vector<struct ActorLink,class std::allocator<struct ActorLink> > (Actor::*rv)(); *((void**)&rv) = dlsym("?getLinks@Actor@@QEBA?AV?$vector@UActorLink@@V?$allocator@UActorLink@@@std@@@std@@XZ"); return (this->*rv)();}
	MCINLINE class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >  getExitTip(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > const & a0,enum InputMode a1){
class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > (Actor::*rv)(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > const &,enum InputMode); *((void**)&rv) = dlsym("?getExitTip@Actor@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBV23@W4InputMode@@@Z"); return (this->*rv)(a0,a1);}
//   bad fun  
	...
	MCINLINE class AABB  getHandleWaterAABB(){
class AABB (Actor::*rv)(); *((void**)&rv) = dlsym("?getHandleWaterAABB@Actor@@UEBA?AVAABB@@XZ"); return (this->*rv)();}
...
public:
	MCINLINE void saveBlockData(class CompoundTag& a0, class BlockSource& a1) {
		void (BlockActor::*rv)(class CompoundTag&, class BlockSource&);
		*((void**)&rv) = dlsym("?saveBlockData@BlockActor@@UEBAXAEAVCompoundTag@@AEAVBlockSource@@@Z");
		return (this->*rv)(a0, a1);
	}
	MCINLINE void load(class Level& a0, class CompoundTag const& a1, class DataLoadHelper& a2) {
	...
	MCINLINE void setCustomName(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const& a0) {
		void (BlockActor::*rv)(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const&);
		*((void**)&rv) = dlsym("?setCustomName@BlockActor@@QEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE class PistonBlockActor* getOwningPiston(class BlockSource& a0) {
	...
	MCINLINE class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const& getCustomName() {
		class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const& (BlockActor::*rv)();
		*((void**)&rv) = dlsym("?getCustomName@BlockActor@@UEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ");
		return (this->*rv)();
	} MCINLINE void onNeighborChanged(class BlockSource& a0, class BlockPos const& a1) {
	...
	MCINLINE void _resetAABB() {
		void (BlockActor::*rv)();
		*((void**)&rv) = dlsym("?_resetAABB@BlockActor@@IEAAXXZ");
		return (this->*rv)();
	}
	...
	MCINLINE class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const& getFilteredCustomName(class UIProfanityContext const& a0) {
		class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const& (BlockActor::*rv)(class UIProfanityContext const&);
		*((void**)&rv) = dlsym("?getFilteredCustomName@BlockActor@@UEAAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBVUIProfanityContext@@@Z");
		return (this->*rv)(a0);
	} MCINLINE float getShadowRadius(class BlockSource& a0) {
		float (BlockActor::*rv)(class BlockSource&);
	...
	MCINLINE void getDebugText(class std::vector<class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>, class std::allocator<class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>>>& a0, class BlockPos const& a1) {
		void (BlockActor::*rv)(class std::vector<class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>, class std::allocator<class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>>>&, class BlockPos const&);
	...
	MCINLINE class BlockActor* getCrackEntity(class BlockSource& a0, class BlockPos const& a1) {
	...
	MCINLINE bool isMovable(class BlockSource& a0) {
		bool (BlockActor::*rv)(class BlockSource&);
		*((void**)&rv) = dlsym("?isMovable@BlockActor@@UEAA_NAEAVBlockSource@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE void onUpdatePacket(class CompoundTag const& a0, class BlockSource& a1) {
		void (BlockActor::*rv)(class CompoundTag const&, class BlockSource&);
		*((void**)&rv) = dlsym("?onUpdatePacket@BlockActor@@UEAAXAEBVCompoundTag@@AEAVBlockSource@@@Z");
		return (this->*rv)(a0, a1);
	}
	MCINLINE bool saveItemInstanceData(class CompoundTag& a0) {
		bool (BlockActor::*rv)(class CompoundTag&);
		*((void**)&rv) = dlsym("?saveItemInstanceData@BlockActor@@UEAA_NAEAVCompoundTag@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE void onPlace(class BlockSource& a0) {
		void (BlockActor::*rv)(class BlockSource&);
	...
	MCINLINE bool isFinished() {
		bool (BlockActor::*rv)();
		*((void**)&rv) = dlsym("?isFinished@BlockActor@@UEAA_NXZ");
		return (this->*rv)();
	}
	MCINLINE float getDeletionDelayTimeSeconds() {
		float (BlockActor::*rv)();
	...
	MCINLINE void tick(class BlockSource& a0) {
		void (BlockActor::*rv)(class BlockSource&);
		*((void**)&rv) = dlsym("?tick@BlockActor@@UEAAXAEAVBlockSource@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE void onCustomTagLoadDone(class BlockSource& a0) {
		void (BlockActor::*rv)(class BlockSource&);
		*((void**)&rv) = dlsym("?onCustomTagLoadDone@BlockActor@@UEAAXAEAVBlockSource@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE void setId(enum BlockActorType a0, class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const& a1) {
		void (BlockActor::*rv)(enum BlockActorType, class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>> const&);
		*((void**)&rv) = dlsym("?setId@BlockActor@@SAXW4BlockActorType@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z");
		return (this->*rv)(a0, a1);
	}
	MCINLINE bool save(class CompoundTag& a0) {
		bool (BlockActor::*rv)(class CompoundTag&);
	...
	MCINLINE void onChunkUnloaded(class LevelChunk& a0) {
		void (BlockActor::*rv)(class LevelChunk&);
		*((void**)&rv) = dlsym("?onChunkUnloaded@BlockActor@@UEAAXAEAVLevelChunk@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE void onChanged(class BlockSource& a0) {
		void (BlockActor::*rv)(class BlockSource&);
		*((void**)&rv) = dlsym("?onChanged@BlockActor@@UEAAXAEAVBlockSource@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE void loadBlockData(class CompoundTag const& a0, class BlockSource& a1, class DataLoadHelper& a2) {
	...
	MCINLINE void initBlockEntities() {
		void (BlockActor::*rv)();
		*((void**)&rv) = dlsym("?initBlockEntities@BlockActor@@SAXXZ");
		return (this->*rv)();
	}

#if 0
	MCINLINE class std::unique_ptr<class Packet,struct std::default_delete<class Packet> >  getUpdatePacket(class BlockSource & a0){
class std::unique_ptr<class Packet,struct std::default_delete<class Packet> > (BlockActor::*rv)(class BlockSource &); *((void**)&rv) = dlsym("?getUpdatePacket@BlockActor@@UEAA?AV?$unique_ptr@VPacket@@U?$default_delete@VPacket@@@std@@@std@@AEAVBlockSource@@@Z"); return (this->*rv)(a0);}
	MCINLINE class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >  getName(){
class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > (BlockActor::*rv)(); *((void**)&rv) = dlsym("?getName@BlockActor@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ"); return (this->*rv)();}
	MCINLINE class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >  getImmersiveReaderText(class BlockSource & a0){
class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > (BlockActor::*rv)(class BlockSource &); *((void**)&rv) = dlsym("?getImmersiveReaderText@BlockActor@@UEAA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAVBlockSource@@@Z"); return (this->*rv)(a0);}
	MCINLINE class std::shared_ptr<class BlockActor>  loadStatic(class Level & a0,class CompoundTag const & a1,class DataLoadHelper & a2){
class std::shared_ptr<class BlockActor> (BlockActor::*rv)(class Level &,class CompoundTag const &,class DataLoadHelper &); *((void**)&rv) = dlsym("?loadStatic@BlockActor@@SA?AV?$shared_ptr@VBlockActor@@@std@@AEAVLevel@@AEBVCompoundTag@@AEAVDataLoadHelper@@@Z"); return (this->*rv)(a0,a1,a2);}
//   bad fun  

	// ??0BlockActor@@QEAA@W4BlockActorType@@AEBVBlockPos@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
	// BlockActor::BlockActor(enum BlockActorType,class BlockPos const &,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > const &)
#endif
};
#pragma once
#include "Core.h"
...
public:
	...
	MCINLINE bool hasComponent(class Util::HashString const& a0) {
		bool (Mob::*rv)(class Util::HashString const&);
		*((void**)&rv) = dlsym("?hasComponent@Mob@@UEBA_NAEBVHashString@Util@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE bool isSprinting() {
		bool (Mob::*rv)();
		*((void**)&rv) = dlsym("?isSprinting@Mob@@UEBA_NXZ");
		return (this->*rv)();
	}
	MCINLINE struct ActorUniqueID getCaravanHead() {
		struct ActorUniqueID (Mob::*rv)();
	...
	MCINLINE float getArmorColorInSlot(enum ArmorSlot a0, int a1) {
		float (Mob::*rv)(enum ArmorSlot, int);
	...
	MCINLINE bool checkSpawnObstruction() {
		bool (Mob::*rv)();
	...
	MCINLINE enum ArmorTextureType getArmorMaterialTextureTypeInSlot(enum ArmorSlot a0) {
		enum ArmorTextureType (Mob::*rv)(enum ArmorSlot);
	...
	MCINLINE float getArmorCoverPercentage() {
		float (Mob::*rv)();
	...
	MCINLINE void knockback(class Actor* a0, int a1, float a2, float a3, float a4, float a5, float a6) {
	...
	MCINLINE struct TextureUVCoordinateSet const* getItemInHandIcon(class ItemStack const& a0, int a1) {
	...
	MCINLINE bool _tryApplyingLevitation(class Vec3& a0) {
		bool (Mob::*rv)(class Vec3&);
	...
	MCINLINE bool canExistWhenDisallowMob() {
		bool (Mob::*rv)();
	...
	MCINLINE void buildDebugInfo(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>& a0) {
		void (Mob::*rv)(class std::basic_string<char, struct std::char_traits<char>, class std::allocator<char>>&);
		*((void**)&rv) = dlsym("?buildDebugInfo@Mob@@UEBAXAEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z");
		return (this->*rv)(a0);
	}
	MCINLINE bool _allowAscendingScaffolding() {
		bool (Mob::*rv)();
...
#if 0
	MCINLINE class std::vector<int,class std::allocator<int> >  getAllArmorID(){
class std::vector<int,class std::allocator<int> > (Mob::*rv)(); *((void**)&rv) = dlsym("?getAllArmorID@Mob@@UEBA?AV?$vector@HV?$allocator@H@std@@@std@@XZ"); return (this->*rv)();}
	MCINLINE class std::vector<class ItemStack const *,class std::allocator<class ItemStack const *> >  getAllEquipment(){
class std::vector<class ItemStack const *,class std::allocator<class ItemStack const *> > (Mob::*rv)(); *((void**)&rv) = dlsym("?getAllEquipment@Mob@@UEBA?AV?$vector@PEBVItemStack@@V?$allocator@PEBVItemStack@@@std@@@std@@XZ"); return (this->*rv)();}
	MCINLINE class std::vector<class ItemStack const *,class std::allocator<class ItemStack const *> >  getAllArmor(){
class std::vector<class ItemStack const *,class std::allocator<class ItemStack const *> > (Mob::*rv)(); *((void**)&rv) = dlsym("?getAllArmor@Mob@@UEBA?AV?$vector@PEBVItemStack@@V?$allocator@PEBVItemStack@@@std@@@std@@XZ"); return (this->*rv)();}
	MCINLINE class std::unique_ptr<class ListTag,struct std::default_delete<class ListTag> >  saveOffhand(){
class std::unique_ptr<class ListTag,struct std::default_delete<class ListTag> > (Mob::*rv)(); *((void**)&rv) = dlsym("?saveOffhand@Mob@@IEBA?AV?$unique_ptr@VListTag@@U?$default_delete@VListTag@@@std@@@std@@XZ"); return (this->*rv)();}
...
class std::unique_ptr<class BodyControl,struct std::default_delete<class BodyControl> > (Mob::*rv)(); *((void**)&rv) = dlsym("?initBodyControl@Mob@@MEAA?AV?$unique_ptr@VBodyControl@@U?$default_delete@VBodyControl@@@std@@@std@@XZ"); return (this->*rv)();}
	MCINLINE class std::vector<class ItemStack const *,class std::allocator<class ItemStack const *> >  getAllHand(){
class std::vector<class ItemStack const *,class std::allocator<class ItemStack const *> > (Mob::*rv)(); *((void**)&rv) = dlsym("?getAllHand@Mob@@UEBA?AV?$vector@PEBVItemStack@@V?$allocator@PEBVItemStack@@@std@@@std@@XZ"); return (this->*rv)();}
//   bad fun  
