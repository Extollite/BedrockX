...
struct RakPeer_t {
	...
	RakAddr_t getAdr(NetworkIdentifier const& ni) {
		RakAddr_t rv;
		SymCall("?GetSystemAddressFromGuid@RakPeer@RakNet@@UEBA?AUSystemAddress@2@URakNetGUID@2@@Z", void, void*, RakAddr_t*, NetworkIdentifier const*)(this, &rv, &ni);
		return rv;
	}
};
class ServerPlayer;
