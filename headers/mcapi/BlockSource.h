...
public:
	...
	MCINLINE bool checkBlockDestroyPermissions(class Actor& a0, class BlockPos const& a1, class ItemStack const& a2, bool a3) {
		bool (BlockSource::*rv)(class Actor&, class BlockPos const&, class ItemStack const&, bool);
		*((void**)&rv) = dlsym("?checkBlockDestroyPermissions@BlockSource@@QEAA_NAEAVActor@@AEBVBlockPos@@AEBVItemStack@@_N@Z");
	...
	MCINLINE bool containsAnyBlockOfType(class BlockPos const& a0, class BlockPos const& a1, class Block const& a2) {
		bool (BlockSource::*rv)(class BlockPos const&, class BlockPos const&, class Block const&);
	...
	MCINLINE class std::vector<class Actor*, class std::allocator<class Actor*>> const& fetchEntities(enum ActorType a0, class AABB const& a1, class Actor* a2) {
	...
	MCINLINE class Actor* fetchNearestEntityOfType(class Actor* a0, class AABB const& a1, enum ActorType a2) {
		class Actor* (BlockSource::*rv)(class Actor*, class AABB const&, enum ActorType);
		*((void**)&rv) = dlsym("?fetchNearestEntityOfType@BlockSource@@QEAAPEAVActor@@PEAV2@AEBVAABB@@W4ActorType@@@Z");
		return (this->*rv)(a0, a1, a2);
	}
	...
	MCINLINE class std::vector<class AABB, class std::allocator<class AABB>>& fetchCollisionShapes(class AABB const& a0, float* a1, bool a2, class Actor* a3) {
		class std::vector<class AABB, class std::allocator<class AABB>>& (BlockSource::*rv)(class AABB const&, float*, bool, class Actor*);
		*((void**)&rv) = dlsym("?fetchCollisionShapes@BlockSource@@QEAAAEAV?$vector@VAABB@@V?$allocator@VAABB@@@std@@@std@@AEBVAABB@@PEAM_NPEAVActor@@@Z");
		return (this->*rv)(a0, a1, a2, a3);
	...
	MCINLINE void updateNeighborsAtExceptFromFacing(class BlockPos const& a0, class BlockPos const& a1, int a2) {
	...
	MCINLINE void fireBlockChanged(class BlockPos const& a0, unsigned int a1, class Block const& a2, class Block const& a3, int a4, struct ActorBlockSyncMessage const* a5) {
		void (BlockSource::*rv)(class BlockPos const&, unsigned int, class Block const&, class Block const&, int, struct ActorBlockSyncMessage const*);
		*((void**)&rv) = dlsym("?fireBlockChanged@BlockSource@@QEAAXAEBVBlockPos@@IAEBVBlock@@1HPEBUActorBlockSyncMessage@@@Z");
	...
	MCINLINE void addToTickingQueue(class BlockPos const& a0, class Block const& a1, int a2, int a3) {
	...
	MCINLINE class std::vector<class Actor*, class std::allocator<class Actor*>> const& fetchActors(struct ActorDefinitionIdentifier const& a0, class AABB const& a1) {
	...
	MCINLINE bool mayPlace(class Block const& a0, class BlockPos const& a1, unsigned char a2, class Actor* a3, bool a4) {
		bool (BlockSource::*rv)(class Block const&, class BlockPos const&, unsigned char, class Actor*, bool);
		*((void**)&rv) = dlsym("?mayPlace@BlockSource@@QEAA_NAEBVBlock@@AEBVBlockPos@@EPEAVActor@@_N@Z");
		return (this->*rv)(a0, a1, a2, a3, a4);
	}
	MCINLINE void fetchBlockEntities(class AABB const& a0, class std::vector<class BlockActor*, class std::allocator<class BlockActor*>>& a1) {
		void (BlockSource::*rv)(class AABB const&, class std::vector<class BlockActor*, class std::allocator<class BlockActor*>>&);
		*((void**)&rv) = dlsym("?fetchBlockEntities@BlockSource@@QEAAXAEBVAABB@@AEAV?$vector@PEAVBlockActor@@V?$allocator@PEAVBlockActor@@@std@@@std@@@Z");
		return (this->*rv)(a0, a1);
	}
	MCINLINE bool findNextSpawnBlockUnder(class BlockPos& a0, enum MaterialType a1) {
		...
		*((void**)&rv) = dlsym("?findNextSpawnBlockUnder@BlockSource@@QEAA_NAEAVBlockPos@@W4MaterialType@@@Z");
		return (this->*rv)(a0, a1);
	}
	...
	MCINLINE class std::vector<class AABB, class std::allocator<class AABB>>& fetchAABBs(class AABB const& a0, bool a1) {
	...
	MCINLINE class std::vector<class Actor*, class std::allocator<class Actor*>> const& fetchEntities2(enum ActorType a0, class AABB const& a1, bool a2) {
	...
	MCINLINE class std::vector<class Actor*, class std::allocator<class Actor*>> const& fetchEntities(class Actor* a0, class AABB const& a1) {
		class std::vector<class Actor*, class std::allocator<class Actor*>> const& (BlockSource::*rv)(class Actor*, class AABB const&);
		*((void**)&rv) = dlsym("?fetchEntities@BlockSource@@QEAAAEBV?$vector@PEAVActor@@V?$allocator@PEAVActor@@@std@@@std@@PEAVActor@@AEBVAABB@@@Z");
		return (this->*rv)(a0, a1);
	...
	MCINLINE float _getLiquidHeight(class BlockPos const& a0, enum MaterialType a1, bool a2) {
		...
		*((void**)&rv) = dlsym("?_getLiquidHeight@BlockSource@@AEAAMAEBVBlockPos@@W4MaterialType@@_N@Z");
		return (this->*rv)(a0, a1, a2);
	}
	...
	MCINLINE void _removeFromTickingQueue(class BlockPos const& a0, class Block const& a1, enum TickingQueueType a2) {
	...
	MCINLINE void addToRandomTickingQueue(class BlockPos const& a0, class Block const& a1, int a2, int a3) {
		void (BlockSource::*rv)(class BlockPos const&, class Block const&, int, int);
		*((void**)&rv) = dlsym("?addToRandomTickingQueue@BlockSource@@QEAAXAEBVBlockPos@@AEBVBlock@@HH@Z");
		return (this->*rv)(a0, a1, a2, a3);
	}
	...
	MCINLINE bool checkBlockPermissions(class Actor& a0, class BlockPos const& a1, unsigned char a2, class ItemStack const& a3, bool a4) {
		bool (BlockSource::*rv)(class Actor&, class BlockPos const&, unsigned char, class ItemStack const&, bool);
		*((void**)&rv) = dlsym("?checkBlockPermissions@BlockSource@@QEAA_NAEAVActor@@AEBVBlockPos@@EAEBVItemStack@@_N@Z");
		return (this->*rv)(a0, a1, a2, a3, a4);
	}
